      ...
      <div className="relative flex h-[calc(100vh-2rem)] w-full max-w-6xl flex-col overflow-hidden rounded-md bg-white shadow-xl dark:bg-zinc-900 sm:h-[90vh] sm:max-h-[52rem]">
        <div className="flex shrink-0 flex-col gap-4 border-b border-zinc-200 p-5 dark:border-zinc-800 sm:flex-row sm:items-start sm:justify-between sm:p-6">
          ...
          <div className="flex shrink-0 flex-wrap items-center gap-2">
            <button
              className="min-h-11 rounded-md bg-zinc-950 px-4 py-2 text-sm font-semibold text-white transition hover:bg-cyan-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-600 dark:bg-zinc-50 dark:text-zinc-950 dark:hover:bg-cyan-200 sm:min-h-0"
        ...
        <div className="grid min-h-0 flex-1 min-w-0 grid-rows-[minmax(14rem,0.85fr)_minmax(0,1.15fr)] gap-0 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)] lg:grid-rows-1">
          <div className="relative flex min-h-0 items-center justify-center overflow-hidden border-b border-zinc-200 bg-zinc-50 px-16 py-8 dark:border-zinc-800 dark:bg-zinc-950 lg:border-b-0 lg:border-r">
            <button
          ...
          <div className="flex min-h-0 min-w-0 flex-col gap-5 overflow-hidden p-5 sm:p-6">
            ...
            >
              ...
              <pre className="min-h-0 flex-1 overflow-auto rounded-md bg-zinc-950 p-4 text-xs leading-6 text-zinc-50 dark:bg-black">
